      ...
      <div className='login-container'>
        ...
        <div className='login-right'>
          <div className='login-right2'>
            ...
            <h5 className='title'>Create an <p className='box'>Account!</p></h5>
          </div>
          <a href='#'>
          ...
          <div className='login-email'>
            ...
            <span className='text'>or Signup with email</span>
            <span className='border border-right'></span>
          </div>
          <form method="POST" className='sign-form'>
            <div className='signin-form'>
              <label for="username">Username</label><br />
              <input type="text" id="text" name="name" value={formValues.name}className='form-control' onChange={handleChange} />
            </div>
          ...
          <div className='login-email or-sign'>
            <span className='border border-left'></span>
            <NavLink to="/login"><span className='text'>or Login</span></NavLink>
            <span className='border border-right'></span>
          </div>
        </div>
      </div>
